...
// register Education_Zone_category_Post widget
function education_zone_register_category_post_widget() {
    register_widget( 'Education_Zone_Category_Post' );
}
add_action( 'widgets_init', 'education_zone_register_category_post_widget' );

 /**
 * Adds Education_Zone_category_Post widget.
 */
class Education_Zone_category_Post extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'education_zone_category_post', // Base ID
			__( 'RARA: category Post', 'education-zone' ), // Name
			array( 'description' => __( 'A category Post Widget', 'education-zone' ), ) // Args
		);
	}
                        ...
                        <article class="post">
                            <?php if( has_post_thumbnail() && $show_thumb ){ ?>
                                ...
                                <a href="<?php the_permalink();?>" class="post-thumbnail">
                                    <?php the_post_thumbnail( 'education-zone-category-post' );?>
                                </a>
                            <?php }?>
	...
	public function form( $instance ) {
		...
		<p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'category' ) ); ?>"><?php _e( 'Slugname of Category of Posts to show', 'education-zone' ); ?></label> 
...
} // class Education_Zone_category_Post