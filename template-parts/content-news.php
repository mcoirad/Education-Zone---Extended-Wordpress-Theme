...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?> style="margin-top:50px;">
	...
	<header class="entry-header col-2 category-post" style="	width: 75%;
...
?>                            <br><span class="posted-on" style="padding: 0 15px;">Published on: <a href="<?php the_permalink(); ?>"><?php echo esc_html( get_the_date( __( 'F jS, Y' , 'education-zone' ) ) ); ?></a></span>
<?php
