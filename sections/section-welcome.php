...
<div class="container">
	...
	$first_stats_suffix   = get_theme_mod( 'education_zone_first_stats_suffix' );
	$first_stats_prefix   = get_theme_mod( 'education_zone_first_stats_prefix' );
	...
	$fourth_stats_suffix   = get_theme_mod( 'education_zone_fourth_stats_suffix' );
    ...
    if( $first_stats_number || $first_stats_title || $second_stats_number || $second_stats_title || $third_stats_number || $third_stats_title || $fourth_stats_number || $fourth_stats_title ){ ?>
        ...
        <div class="row">
            ...
            <?php if( $first_stats_number && $first_stats_title ){ ?>
            	<div class="col">
            		<div class="text">
						<?php } if( $first_stats_suffix || $first_stats_prefix){ ?>
						
							<h3 style="display:inline-block;"><?php echo $first_stats_prefix; ?></h3><h3 class="number" style="display:inline-block;"><?php echo absint( $first_stats_number ); ?></h3><h3 style="display:inline-block;"><?php echo $first_stats_suffix; ?></h3>
            ...
            <?php }  if( $fourth_stats_number && $fourth_stats_title ){ ?>
            	<div class="col">
            		<div class="text">
					  <h3 class="number" style="display:inline-block;"><?php echo absint( $fourth_stats_number ); ?></h3><h3 style="display:inline-block;"><?php echo $fourth_stats_suffix; ?></h3>
